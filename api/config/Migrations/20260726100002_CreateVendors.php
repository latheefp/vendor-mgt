...
/**
 * SUPERSEDED NAMING — see 20260727100012_RenameVendorToCompany.
 *
 * This migration still builds `vendors` / `vendor_agreements` because it
 * has already been applied and a migration that has run is history, not
 * a document. Migration 12 renames both to `companies` and
 * `company_agreements`, which is what the rest of the codebase now calls
 * them, and what the signed agreement calls Dianora. Read "vendor" below
 * as "company" throughout; do not edit this file to match.
 *
 * Companies (the manufacturers whose warranty work we perform) and the
