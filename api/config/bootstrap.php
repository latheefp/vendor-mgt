...
*/
/*
 * In Docker the environment is injected by compose, so APP_NAME is
 * already set and this is skipped. It only kicks in when you run the
 * console from the host (`bin/cake migrations migrate`, phpunit),
 * where config/.env points at the published MySQL port instead.
 */
