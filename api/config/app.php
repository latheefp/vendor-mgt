...
return [
    ...
    'Error' => [
        ...
        // This app answers in JSON and nothing else. Both defaults render
        // HTML — the error renderer by echoing it mid-request, which starts
        // the body and locks in an implicit 200 that the real 500 can then
        // no longer overwrite. See App\Error\SilentErrorRenderer.
        'errorRenderer' => \App\Error\SilentErrorRenderer::class,
